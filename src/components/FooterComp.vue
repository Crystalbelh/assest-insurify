            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="/services" class="text-gray-400 hover:text-white transition-colors duration-300">Crypto
                                    Insurance</a>
                            </li>
                            <li>
                                <a href="/services" class="text-gray-400 hover:text-white transition-colors duration-300">NFT
                                    Protection</a>
                            </li>
                            <li>
                                <a href="/services"
                            ...
                            <li>
                                <a href="/services" class="text-gray-400 hover:text-white transition-colors duration-300">Wallet
                                    Security</a>
                            </li>
                        </ul>
                    </div>
...
<script setup>
import Logo from '../../public/images/Assets-logo1.png';
